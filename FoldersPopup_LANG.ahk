...
global lHelpText2 := "Choose ""Settings"" to open the FoldersPopup settings window where you can add folders to your menu, move, rename or delete them. You can add sub-menus and move, rename or delete them as well. Choose the ""Menu to edit:"" in the  dropdown list. Click ""Save"" to save your changes."
global lHelpText3 := "You can quickly add new folders to the popup menu:`n1) Go to a frequently used folder.`n2) Click the Middle mouse button (or press Windows-K) and choose ""Add This Folder"".`n3) Give the folder a short name, click ""OK"" and ""Save"" in the settings window.`nThis new folder is saved in the main menu. Edit the folder to move it to a sub-menu."
