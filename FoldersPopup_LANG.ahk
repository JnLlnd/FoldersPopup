...
global lMenuReservedShortcuts := "SRWFA"
...
global lOopsWrongDirectoryOpusPath := "Wrong Directory Opus path or file name in ~1~.ini file:`n""~2~""`n`nEnter the full path and name of the DOpus.exe file, for example (without the quotes):`n""DirectoryOpusPath=C:\Program Files\GPSoftware\Directory Opus\dopus.exe"""
...
global lOptionsLanguageLabels := "English|French|German|Dutch|Korean"
