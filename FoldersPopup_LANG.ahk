...
global lOptionsTitlesLong := "over an Explorer or Dialog box|for a new Explorer|in the Explorer or Dialog box|for a New Explorer|for Settings window"
global lOptionsTriggerFor := "Trigger for"
global lOptionsWin := "Win"
global lTrayTipInstalledDetail := "To show ~1~`, press:`n" ; - MIDDLE mouse button over Windows Explorer`n- MIDDLE mouse button over a file dialog box`n- SHIFT+MIDDLE mouse button anywhere."
