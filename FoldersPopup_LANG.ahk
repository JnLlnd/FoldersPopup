...
global lHelpText1 := "At its launch, FoldersPopup add an icon in the System Tray and await your orders. When you need to change the current folder in Windows Explorer or in a file dialog box, on your mouse just click the ~1~ or press ~2~ and, in the popup menu, select the desired folder. FoldersPopup will take you there this instantly! Or use it to open quickly a favorite document or web page."
...
global lHelpText3 := "To quickly ADD a new favorite FOLDER to the popup menu:`n1) Go to a frequently used folder.`n2) On your mouse, click the ~1~ (or press ~2~) and choose ""Add This Folder"".`n3) Give the folder a short name, click ""Add"", then ""Save"" in the settings window."
global lHelpText4 := "To add a new favorite DOCUMENT or WEB LINK to the popup menu:`n1) Open the Folders Popup menu and choose ""Settings"" (~1~).`n2) Click the ""Add"" button and choose the option ""Document"" or ""Link (URL)"".`n3) Give the favorite a short name, ""Browse"" to the document or enter the web page's URL, click ""Add"", then ""Save"" in the settings window."
global lHelpText5 := "- In the Tray menu, right-click on the Folders Popup icon and check the ""Run at Startup"" option to launch FoldersPopup automatically at startup.`n- Need a new file Explorer window while working in an application? From any window, on your mouse, click ~1~ (or ~2~), or simply click on the Folders Popup icon in the System Tray, and choose your favorite folder.`n- Choose the ""Recent folders..."" menu (~3~) to show an updated list of the Windows recent folders.`n- Use the ""Current Folders"" menu (~4~) to open one of the folders already open in an Explorer window or the ""Groups of Folders"" menu (~5~) to save and restore groups of folders.`n- Access the files or URLs in your Clipboard from the ""Clipboard"" menu (~6~) or paste the location of any favorite to the Clipboard using the ""Paste Favorite's Location"" menu (~7~).`n- Configure your popup menu triggers: choose your preferred mouse buttons or keyboard shortcuts in ""Settings, Options"".`n- Also in ""Options"": choose your preferred language, menu icons size, windows colors. Select the options to display recent folders, add numeric keyboard shortcuts to the folders menu or pin the popup menu at a fix position.`n-Directory Opus users, see <a href=""http://code.jeanlalonde.ca/using-folderspopup-with-directory-opus/"">this page</a> for additional information.`n-Total Commander users, see <a href=""http://code.jeanlalonde.ca/using-folderspopup-with-total-commander/"">this page</a> for additional information."
...
global lMenuPasteLocation := "Paste Favorite's Location"
...
global lMenuReservedShortcuts := "" ; "FGRCSA" ; "SCGRBFA"
...
global lOptionsArrDescriptions5 := "Choose the hotkey or mouse button combination that will open the FoldersPopup ""Recent Folders"" menu. By default, this is Shift+Control+R."
global lOptionsArrDescriptions6 := "Choose the hotkey or mouse button combination that will open the FoldersPopup ""Settings"" dialog box. By default, this is Shift+Control+S."
global lOptionsArrDescriptions7 := "Choose the hotkey or mouse button combination that will open the FoldersPopup ""Groups of Folders"" menu. By default, this is Shift+Control+G."
global lOptionsArrDescriptions8 := "Choose the hotkey or mouse button combination that will open the FoldersPopup ""Recent Folders"" menu. By default, this is Shift+Control+R."
global lOptionsArrDescriptions9 := "Choose the hotkey or mouse button combination that will open the FoldersPopup ""Clipboard"" menu. By default, this is Shift+Control+C."
global lOptionsArrDescriptions10 := "Choose the hotkey or mouse button combination that will open the FoldersPopup ""Paste Favorite's Location"" menu. By default, this is Shift+Control+V."
...
global lOptionsDisplayPasteLocationdMenu := "Paste Favorite's Location"
...
global lOptionsLanguageLabels := "English|French|German|Dutch|Korean|Swedish|Italian|Spanish"
...
global lOptionsMouseButtonsText := "Left Button|Middle Button|Right Button|Special Button 1|Special Button 2|Wheel Up|Wheel Down|Wheel Left|Wheel Right|"
...
global lOptionsPasteLocation := "~1~ pastes favorite's location:"
global lOptionsPasteLocationRadioClipboard := "&In the Clipboard"
global lOptionsPasteLocationRadioKeyboard := "At the current &keyboard insert point"
...
global lPasteLocationCopiedToClipboard := "Location copied to the Clipboard"
...
global lPopupMenuPasteTrayTip := "Select the favorite to paste"
