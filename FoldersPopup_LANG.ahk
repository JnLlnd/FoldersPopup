...
global lAboutText3 := chr(169) . " Jean Lalonde 2013-2014. Freeware."
...
global lDialogInvalidHotkey := "With your current system keyboard layout, the hotkey ""~1~"" could not be used as a trigger for the popup menu (not a valid key namse error).`n`nPlease, open the ""Folders Popup Settings"" window from the Tray menu and click ""Options"". In this dialog box, choose another shortcut for ""~2~""."
