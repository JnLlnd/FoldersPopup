...
global lDialogFavoriteDoesNotExistPrompt := "The favorite ""~1~"" does not exist or is not available.`n`nIf this favorite is on a network drive, please try again after network authentification."
...
global lDialogReplaceShortName := "Replace favorite name ""~1~"" with ""~2~""?"
...
global lHelpText1 := "At its launch, FoldersPopup add an icon in the System Tray and await your orders. When you need to change folder in Windows Explorer or in a file dialog box, just click the Middle mouse button or press Windows-K and, in the popup menu, select the desired folder. FoldersPopup will take you there this instantly! Or click a favorite document to launch it immediately."
global lHelpText2 := "Choose ""Settings"" to open the FoldersPopup settings window where you can add favorite folders or documents to your menu, move, rename or delete them. You can add submenus and move, rename or delete them as well. Choose the ""Menu to edit:"" in the  dropdown list. Click ""Save"" to save your changes."
global lHelpText3 := "You can quickly add new favorite folders to the popup menu:`n1) Go to a frequently used folder.`n2) Click the Middle mouse button (or press Windows-K) and choose ""Add This Folder"".`n3) Give the folder a short name, click ""OK"" and ""Save"" in the settings window."
...
global lHelpTextLead := "FoldersPopup lets you move like a breeze between your frequently used folders and documents!"
