...
global lDialogFavoriteNameNoColumnBreak := "The menu name cannot start the reserved characters ""~1~"" used as column break indicators."
...
global lDialogGroupLoadErrorLoading := "Error loading group window:`n`n""~1~""`n`nAborting group load..."
global lDialogGroupManageCannotSave := "Warning: There is no open window to save in a new group. Open at least one Explorer or Directory Opus window and try again to save a new group."
...
global lMenuColumnBreakIndicator := "==="
...
global lMenuFoldersInExplorer := "Folders in Explorer"
...
global lOptionsDisplayFoldersInExplorerMenu := "Folders in Explorer"
...
global lPicIconNoLocation := "First select the document before choosing an icon."
