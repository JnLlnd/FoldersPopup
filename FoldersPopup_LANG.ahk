...
global lGuiHotkeysHelpText := "Down: Select next favorite`nUp: Select previous favorite`nEnter: Edit favorite`n`nCtrl-Down: Move favorite down`nCtrl-Up: Move favorite up`n`nCtrl-Right: Open submenu`nCtrl-Left: Open parent submenu`n`nCtrl-A: Select all"
