...
global lOptionsTitles := "FP menu to open folders in the current Explorer or dialog box (mouse)|FP menu to open folders in a new Explorer (mouse)|FP menu to open folders in the current Explorer or dialog box (keyboard)|FP menu to open folders in a new Explorer (keyboard)|Settings window|Current folders menu|Groups menu|Recent folders menu|Clipboard menu"
